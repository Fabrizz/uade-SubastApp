...
const ROUTES = [
  ...
  { name: "Perfil: Estadísticas", path: "/(tabs)/profile/stats", icon: "stats-chart-outline" },
  { name: "Perfil: Métodos de Pago", path: "/(tabs)/profile/payment", icon: "card-outline" },
  { name: "Perfil: Agregar Método", path: "/(tabs)/profile/payment/new", icon: "add-circle-outline" },
  { name: "Perfil: Agregar Tarjeta", path: "/(tabs)/profile/payment/new/add-card", icon: "add-circle-outline" },
  { name: "Perfil: Cargar Cheque", path: "/(tabs)/profile/payment/new/add-check", icon: "document-text-outline" },
  { name: "Perfil: Vincular Cuenta", path: "/(tabs)/profile/payment/new/add-bank-account", icon: "business-outline" },
  ...
  { name: "Pantalla: Mi Compra (Test ID: 1)", path: "/(tabs)/auctions/compra/1?subastaId=1", icon: "checkmark-circle-outline" },
