...
const METHODS = [
  {
    ...
    route: "/(tabs)/profile/payment/new/add-card" as const,
    Icon: CreditCard,
  },
  {
    id: "check",
    ...
    route: "/(tabs)/profile/payment/new/add-check" as const,
    Icon: FileCheck,
  },
  {
    id: "bank",
    ...
    route: "/(tabs)/profile/payment/new/add-bank-account" as const,
    Icon: Building2,
  },
];
